" Vim Ghost
"
" Note: Based on github's syntax highlighting theme by Anthony Carapetis.
...
let colors_name = "ghost-win"

" {{{ General colors
hi Normal   ctermfg=0   ctermbg=255  guifg=#000000   guibg=#FFFFFF
hi Cursor   ctermfg=239   ctermbg=15  guifg=#FFFFFF   guibg=#444454
...
hi VertSplit ctermfg=250 ctermbg=250 guifg=#FFFFFF guibg=#FFFFFF gui=none cterm=none
...
hi ErrorMsg ctermbg=15 ctermfg=196 guibg=#FFFFFF guifg=#ff1100 gui=undercurl cterm=undercurl
...
hi DiffChange ctermbg=255  guibg=#FFFFFF gui=none   cterm=none
...
hi Todo         ctermbg=15 ctermfg=196 guibg=#FFFFFF guifg=#ff1100 gui=underline cterm=underline
